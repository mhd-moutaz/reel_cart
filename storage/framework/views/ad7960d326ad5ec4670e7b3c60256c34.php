<?php $__env->startSection('title', 'إدارة العناوين - لوحة التحكم'); ?>
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/addresses-styles.css')); ?>">
    <style>
        .verification-toggle {
            display: flex;
            align-items: center;
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-header" style="background: linear-gradient(90deg,#2c3e50,#34495e);">
        ...
        <div class="page-stats">
            <span class="stat-badge">إجمالي: <?php echo e($stores->count() ?? 0); ?></span>
        </div>
    </div>
    ...
    <div class="addresses-grid">
        <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="address-card <?php echo e($store->is_default ? 'default' : ''); ?>" data-store-id="<?php echo e($store->id); ?>">
                <div class="address-header">
                    <div class="address-icon">🏢</div>
                    <div class="address-info">
                        <div class="customer-name"><?php echo e($store->store_name); ?></div>
                        <div class="customer-phone">📱 <?php echo e($store->vendor->user->phone_number); ?></div>
                    </div>
                </div>
                ...
                <div class="address-details">
                    <div class="address-row">
                        ...
                        <span class="address-value"><?php echo e($store->vendor->user->name); ?></span>
                    </div>
                    <div class="address-row">
                        <span class="address-label">العنوان:</span>
                        <span class="address-value"><?php echo e($store->address ?? '-'); ?></span>
                    </div>
                    <div class="address-row">
                        <span class="address-label">أوقات الفتح :</span>
                        <span class="address-value"><?php echo e($store->opening_hours ?? '-'); ?></span>
                    </div>
                    <div class="address-row">
                        <span class="address-label">حالة التحقق:</span>
                        <span class="verification-status <?php echo e($store->is_verified ? 'verified' : 'not-verified'); ?>">
                            <?php echo e($store->is_verified ? '✓ موثق' : '✗ غير موثق'); ?>
                    ...
                    <div class="verification-toggle">
                        ...
                        <label class="toggle-switch">
                            <input type="checkbox"
                                   ...
                                   <?php echo e($store->is_verified ? 'checked' : ''); ?>>
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('js/addresses-scripts.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('admin.layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mouaz\Desktop\blog\reel_cart\resources\views/admin/Store.blade.php ENDPATH**/ ?>